...
> **🌐 Live Production Web Application**: [https://van-ola-frontend-wtdb.vercel.app/](https://van-ola-frontend-wtdb.vercel.app/)

VanOla is a real-time coordinates broadcasting system designed for college van coordination (VIT Bhopal Campus). It allows drivers to dynamically declare stops, reorder pickup priority, rename stops, and share their location in real-time along road-following Google Maps lines. Students can track the van in real-time with live ETAs and sequence order.
